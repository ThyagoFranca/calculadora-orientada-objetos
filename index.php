...
<html lang="pt-br">
	<head>
        ...
        <meta name="description" content="Calculadora em PHP Orientada Objeto">
        <meta name="author" content="Thyago França">

        <title>Calculadora em PHP Orientada Objeto</title>
	...
	<body>
		...
		<section id="calculadora">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 class="jumbotron text-center mb-5">Calculadora em PHP Orientada Objeto</h1>
						...
						<form method="post">
							...
							<div class="form-group col-md-12">
							    ...
							    <input type="text" name="resultado" id="resultado" class="form-control" placeholder="Resultado">
						    </div>
						</form>
	...
	<script>
        document.getElementById('resultado').value = '<?php echo $calculadora->getTotal(); ?>';
    </script>
